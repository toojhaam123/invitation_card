...
const Home = () => {
  ...
  useEffect(() => {
    const fetchInvitations = async () => {
      try {
        const res = await privateApi.get("/invitations"); // API lấy danh sách thiệp của user
      ...
      <div className="max-w-6xl mx-auto">
        {loading ? (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <img
                    src={
                      item.cover_image
                        ? `http://localhost:8000/storage/invitations/covers/${item.cover_image}`
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-2 sm:gap-3 items-center mt-4">
                    {/* Nút Xem thiệp - Ưu tiên chiều rộng nhưng không được bóp các nút khác */}
                    <Link
                      to={`/${item.slug}`}
          ...
          <div className="bg-white rounded-2xl p-12 text-center border-2 border-dashed border-gray-200">
            ...
            <Link to="/create" className="text-[#c94b6a] font-bold underline">
              Bắt đầu tạo ngay!
            </Link>
          </div>
        )}
